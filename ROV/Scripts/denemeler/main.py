...
if __name__ == "__main__":
    ...
    Process1 = Process(target=ProcessMaker, args=(openedUSBs[0],))
    Process2 = Process(target=ProcessMaker, args=(openedUSBs[1],))
    Process3 = Process(target=ProcessMaker, args=(openedUSBs[2],))
    Process4 = Process(target=ProcessMaker, args=(openedUSBs[3],))
